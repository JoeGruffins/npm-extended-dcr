...
exports.outputToTrezor = exports.validateHDOutput = exports.validateDecredTicketOutputs = exports.validateTrezorOutputs = void 0;
...
var validateTrezorOutputs = function validateTrezorOutputs(outputs, coinInfo) {
  var trezorOutputs = outputs.map(_pathUtils.fixPath).map(_hdnode.convertMultisigPubKey.bind(null, coinInfo.network));
...
var validateDecredTicketOutputs = function validateDecredTicketOutputs(outputs, coinInfo) {
  var trezorOutputs = outputs.map(_pathUtils.fixPath).map(_hdnode.convertMultisigPubKey.bind(null, coinInfo.network));

  for (var _iterator2 = _createForOfIteratorHelperLoose(trezorOutputs), _step2; !(_step2 = _iterator2()).done;) {
...
exports.validateDecredTicketOutputs = validateDecredTicketOutputs;
