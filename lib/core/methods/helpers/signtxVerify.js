      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            return _context2.abrupt("return", _utxoLib.script.sstxSubmissionPKH.output.encode(h));
          ...
          case 9:
            ...
            _h = (0, _addressUtils.getAddressHash)(output.address, coinInfo);
            return _context2.abrupt("return", _utxoLib.script.sstxSubmissionSH.output.encode(_h));
          ...
          case 12:
            ...
            _pkh = (0, _addressUtils.getAddressHash)(output.address, coinInfo);
            return _context2.abrupt("return", _utxoLib.script.sstxChange.output.encode(_pkh));
