...
var verifyTicket = /*#__PURE__*/function () {
  var _ref4 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(inputs, outputs, serializedTx, coinInfo) {
    var bitcoinTx, i, scriptB, output, scriptA, amount, h, _amount, pkh;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 6:
            ...
            throw _constants.ERRORS.TypedError('Runtime', "verifyTicket: Wrong output amount at output " + i + ". Requested: " + amount + ", signed: " + bitcoinTx.outs[i].value);
          ...
          case 25:
            ...
            throw _constants.ERRORS.TypedError('Runtime', "verifyTicket: Wrong output amount at output " + i + ". Requested: " + _amount + ", signed: " + bitcoinTx.outs[i].value);
