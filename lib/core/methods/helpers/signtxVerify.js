...
exports.verifyTicket = exports.verifyTx = void 0;
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 13:
            _context2.t0 = (0, _addressUtils.getAddressHash)(output.address, coinInfo);
...
var verifyTx = /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(getHDNode, inputs, outputs, serializedTx, coinInfo) {
    var bitcoinTx, i, scriptB, amount, bitTxAmt, scriptA;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 6:
            ...
            bitTxAmt = typeof bitcoinTx.outs[i].value === 'number' ? bitcoinTx.outs[i].value.toString() : bitcoinTx.outs[i].value;
            ...
            throw _constants.ERRORS.TypedError('Runtime', "verifyTx: Wrong output amount at output " + i + ". Requested: " + amount + ", signed: " + bitTxAmt);
...
var verifyTicket = /*#__PURE__*/function () {
  var _ref4 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(inputs, outputs, serializedTx, coinInfo) {
    var bitcoinTx, i, scriptB, output, scriptA, amount, bitTxAmt, h, _amount, _bitTxAmt, pkh;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 6:
            ...
            throw _constants.ERRORS.TypedError('Runtime', "verifyTicket: Wrong output amount at output " + i + ". Requested: " + amount + ", signed: " + bitTxAmt);

          case 15:
            h = (0, _addressUtils.getAddressHash)(output.address, coinInfo);
            scriptA = _utxoLib.script.sstxSubmissionPKH.output.encode(h);
            _context4.next = 32;
            break;
          ...
          case 19:
            ...
            throw _constants.ERRORS.TypedError('Runtime', "verifyTicket: Output 1 should have not address.");
          ...
          case 22:
            ...
            throw _constants.ERRORS.TypedError('Runtime', "verifyTxicket: Output 1 should have address_n.");
          ...
          case 26:
            ...
            _bitTxAmt = typeof bitcoinTx.outs[i].value === 'number' ? bitcoinTx.outs[i].value.toString() : bitcoinTx.outs[i].value;

            if (!(_amount !== _bitTxAmt)) {
              _context4.next = 30;
              break;
            }

            throw _constants.ERRORS.TypedError('Runtime', "verifyTicket: Wrong output amount at output " + i + ". Requested: " + _amount + ", signed: " + _bitTxAmt);

          case 30:
            pkh = (0, _addressUtils.getAddressHash)(output.address, coinInfo);
            scriptA = _utxoLib.script.sstxChange.output.encode(pkh);
          ...
          case 32:
            ...
            throw _constants.ERRORS.TypedError('Runtime', "verifyTxicket: Output " + i + " scripts differ");
  ...
  return function verifyTicket(_x12, _x13, _x14, _x15) {
