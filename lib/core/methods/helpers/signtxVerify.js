      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 18:
            ...
            throw _constants.ERRORS.TypedError('Runtime', "verifyTx: Output 1 should have not address.");
          ...
          case 21:
            ...
            throw _constants.ERRORS.TypedError('Runtime', "verifyTx: Output 1 should have address_n.");
          ...
          case 25:
            ...
            throw _constants.ERRORS.TypedError('Runtime', "verifyTx: Wrong output amount at output " + i + ". Requested: " + _amount + ", signed: " + bitcoinTx.outs[i].value);
