...
var CardanoGetAddress = /*#__PURE__*/function (_AbstractMethod) {
  ...
  function CardanoGetAddress(message) {
    ...
    payload.bundle.forEach(function (batch) {
      ...
      bundle.push({
        addressParameters: (0, _cardanoAddressParameters.addressParametersToProto)(batch.addressParameters),
    ...
    if (bundle.length === 1) {
      _this.info = "Export Cardano address for account #" + (0, _pathUtils.fromHardened)(_this.params[0].addressParameters.address_n[2]);
    } else {
  ...
  _proto.getButtonRequestData = function getButtonRequestData(code) {
    if (code === 'ButtonRequest_Address') {
      var data = {
        type: 'address',
        serializedPath: (0, _pathUtils.getSerializedPath)(this.params[this.progress].addressParameters.address_n),
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              _context3.next = 7;
              return this.device.getCommands().cardanoGetAddress(batch.addressParameters, batch.protocolMagic, batch.networkId, false);
            ...
            case 14:
              _context3.next = 16;
              return this.device.getCommands().cardanoGetAddress(batch.addressParameters, batch.protocolMagic, batch.networkId, batch.showOnTrezor);

            case 16:
              response = _context3.sent;
              responses.push({
                addressParameters: (0, _cardanoAddressParameters.addressParametersFromProto)(batch.addressParameters),
                protocolMagic: batch.protocolMagic,
                networkId: batch.networkId,
                serializedPath: (0, _pathUtils.getSerializedPath)(batch.addressParameters.address_n),
                serializedStakingPath: (0, _pathUtils.getSerializedPath)(batch.addressParameters.address_n_staking),
