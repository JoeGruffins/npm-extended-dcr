...
var httpRequest = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(url, type) {
    var fileUrl, dir, content;
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            fileUrl = url.split('?')[0]; // fileUrl = path.resolve(__dirname, '../../../', fileUrl);
            // NOTE: decred hack...

            dir = process.cwd() + "/app/node_modules/connect";
            fileUrl = _path["default"].resolve(dir, '.', fileUrl);
